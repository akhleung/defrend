...
function M.update(settings, draw_options)
	...
	render.enable_texture("glow_sampler", g_buffer, graphics.BUFFER_TYPE_COLOR2_BIT)
	render.enable_texture("color_sampler", g_buffer, graphics.BUFFER_TYPE_COLOR0_BIT)
	render.draw(predicates.screen)
