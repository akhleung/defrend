...
return function (self)
	local light_uniforms_changed = false
	...
	imgui.color_edit4("Ambient color", new_ambient_color)
	...
	imgui.color_edit4("Fog color", new_fog_color)
	...
	if light_uniforms_changed then
		uniforms.light.init()
	end
end
