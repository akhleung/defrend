...
return function (self)
	local shadow_properties_changed = false

	local changed, checked = imgui.checkbox("Shadows enabled", go.get(SCRIPT_URL, "enabled"))
	if changed then
		go.set(SCRIPT_URL, "enabled", checked)
		shadow_properties_changed = true
	end
	...
	if shadow_properties_changed then
